...
==== Example usage:
Imagine that you wanted to take a look at how much you spent and saved the previous month! For example, Sep 2019.

To `list` the transactions by a specific month(Sep 2019):

1. The default interface shows all transactions for the current month, in this case Oct 2019.
'insert screenshot oct'

2. You can simply type *list m/09/2019* into the command input and press **Enter**.
'insert screenshot sep'
