...
* Returns a list of all expenses for the current month and remaining budget left.
* Returns a list of all food expenses for the specified month and remaining budget left.
